...
export function BottomNav() {
  ...
  return (
    <div ref={navRef} className="fixed bottom-0 left-1/2 -translate-x-1/2 z-40 w-full max-w-sm pointer-events-none" style={{ paddingBottom: 'calc(1rem + env(safe-area-inset-bottom, 0px))', paddingLeft: '1rem', paddingRight: '1rem' }}>
