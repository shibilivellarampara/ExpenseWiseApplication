...
export function BottomNav() {
  ...
  return (
    <div ref={navRef} className="fixed bottom-0 left-0 right-0 z-40 w-full max-w-sm mx-auto pointer-events-none" style={{ paddingBottom: 'calc(0.5rem + env(safe-area-inset-bottom, 0px))' }}>
