  ...
  return (
    <div className="space-y-4">
      ...
      <Tabs defaultValue="email" value={loginMethod} className="w-full" onValueChange={handleLoginMethodChange}>
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit((data) => {
                ...
                <Button type="submit" className="w-full" disabled={isLoading || isGoogleLoading || !auth || !form.formState.isValid}>
      ...
      <div className="grid grid-cols-1 gap-2">
       <Button variant="outline" className="w-full h-9 opacity-50" onClick={handleGoogleSignIn} disabled={isLoading || isGoogleLoading || !auth}>
