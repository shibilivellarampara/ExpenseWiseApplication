...
export const defaultCategories = [
  ...
  { name: 'Fuel', icon: 'Fuel' },
  { name: 'Rent', icon: 'Home' },
  { name: 'EMI Payment', icon: 'CalendarClock' },
  ...
  { name: 'Cashback', icon: 'BadgePercent' },
  { name: 'Bank Interest', icon: 'TrendingUp' },
...
export const availableIcons = [
  ...
  "TrendingDown", "PenTool", "CandlestickChart", "Carrot", "Fuel", "Scale",
  "BadgePercent", "Heart", "Eraser", "Truck", "Users", "AlertTriangle",
